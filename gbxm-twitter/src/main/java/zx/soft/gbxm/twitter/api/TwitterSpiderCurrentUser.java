 ...
 */
public class TwitterSpiderCurrentUser {
    private static Logger logger = LoggerFactory.getLogger(TwitterSpiderCurrentUser.class);
     ...
     */
    public void getUserTweetAndPost(String screenName){
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        TwitterSpiderCurrentUser spiderCurrentUser = new TwitterSpiderCurrentUser();
        spiderCurrentUser.getUserTweetAndPost("BillGates");
    }
